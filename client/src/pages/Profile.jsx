...
export default function Profile() {
  ...
  const [updateSuccess,setUpdateSuccess]=new useState(false);
  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      {fileUploadError ? (
        <span className='text-red-700'>Error Image upload(image must be below 2 mb)</span>
        ...
        <input onChange={handleChange} className='border p-3 rounded-lg' type="email" placeholder='email' id='email' defaultValue={currentUser.email}/>
